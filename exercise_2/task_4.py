...
def train_loop():
    ...
    standard_deviation_2 = 1/np.sqrt(128)
    w1 = np.random.randn(128, X_train.shape[1])*standard_deviation_1
    w2 = np.random.randn(Y_train.shape[1], 128)*standard_deviation_2
